...
export function CategoryPageClient({ category, meta, products, categoryDescription }: CategoryPageClientProps) {
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-7xl px-6 py-12">
          <Breadcrumbs items={[{ label: "Спилы", href: "/spily" }, { label: meta.h1 }]} />

          <div className="mt-8 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
              <h1 className="text-4xl font-light tracking-tight md:text-5xl">{meta.h1}</h1>
              <p className="mt-4 max-w-xl text-muted-foreground">{categoryDescription}</p>
            </div>
              ...
              {category === "bereza" ? (
                <>
                  <p className="leading-relaxed">
                    Берёза — одно из самых популярных деревьев для создания декоративных спилов. Её светлая древесина с
                    характерной белой корой создаёт нежный, скандинавский стиль в интерьере.
                  </p>
                  <p className="leading-relaxed">
                    Спилы берёзы идеальны для свадебного декора, подставок под посуду, основы для часов и настенных
                    панно. Текстура древесины мягкая, хорошо поддаётся обработке и росписи.
                  </p>
                </>
              ) : (
                <>
                  <p className="leading-relaxed">
                    Сосна отличается тёплыми оттенками древесины и выраженным рисунком годовых колец. Каждый спил сосны
                    — это маленькое произведение природы с уникальным узором.
                  </p>
                  <p className="leading-relaxed">
                    Из спилов сосны создают часы, сервировочные доски, подставки и декоративные элементы. Древесина
                    прочная, хорошо держит нагрузку и долговечна.
                  </p>
                </>
              )}
            </div>
